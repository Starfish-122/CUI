export const importCode = `import SearchBar from '@/components/common/searchBar';`;

export const basicCode = `<SearchBar 
    placeholder="검색어를 입력하세요"
    onSearch={(value) => console.log('검색:', value)}
/>`;

export const controlledCode = `const [searchValue, setSearchValue] = useState('');
...
export const withIconCode = `<SearchBar 
    placeholder="아이콘이 있는 검색바"
    onSearch={(value) => console.log('검색:', value)}
    icon={<Icon name="search" size="md" />}
/>`;

export const disabledCode = `<SearchBar 
    placeholder="비활성화된 검색바"
    disabled
    onSearch={(value) => console.log('검색:', value)}
/>`;

export const customStyleCode = `<SearchBar 
...
export const eventHandlingCode = `const [searchValue, setSearchValue] = useState('');
