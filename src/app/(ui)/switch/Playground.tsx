...
const SwitchPlayground = (): React.JSX.Element => {
    const [controls, setControls] = useState<SwitchControls>({
        label: '스위치',
        $variant: 'default',
        $size: 'md',
        disabled: false,
    ...
    const handleSwitchChange = (event: any, checked: boolean): void => {
    ...
    const renderPreview = (controls: SwitchControls): React.JSX.Element => (
        <Switch
