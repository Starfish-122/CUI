export const importCode = `import Switch from '@/components/base/switch/Switch';`;

export const variantCode = `<Switch label="기본 스위치" />
...
export const sizeCode = `<Switch $size="sm" label="작은 스위치" />
<Switch $size="md" label="중간 스위치" />
<Switch $size="lg" label="큰 스위치" />`;

export const optionCode = `<Switch disabled label="비활성화된 스위치" />
<Switch 
    $bgColor="#9C27B0" 
    $thumbColor="#FFFFFF" 
    label="커스텀 색상 스위치" 
