...
export const importCode: string = `import Radio from '@/components/base/radio';`;

export const variantCode: string = `<Radio name="style" value="default">기본 스타일</Radio>
...
export const sizeCode: string = `<Radio name="size" value="sm" $size="sm">작은 크기</Radio>
<Radio name="size" value="md" $size="md">중간 크기</Radio>
<Radio name="size" value="lg" $size="lg">큰 크기</Radio>`;

export const colorCode: string = `<Radio name="color" value="custom1" $bgColor="#FF6B6B" $textColor="#d8d6d5">
    배경 + 텍스트 1
</Radio>
...
export const eventCode: string = `const [selectedValue, setSelectedValue] = useState('');
...
export const groupCode: string = `const [selectedFruit, setSelectedFruit] = useState('apple');
...
export const radioProps: RadioProp[] = [
    {
        name: 'children',
        default: '-',
        type: 'ReactNode',
