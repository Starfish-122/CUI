...
export const importCode: string = `import CheckBox from '@/components/base/checkBox';`;

export const variantCode: string = `<CheckBox>기본 스타일</CheckBox>
...
export const sizeCode: string = `<CheckBox $size="sm">작은 크기</CheckBox>
<CheckBox $size="md">중간 크기</CheckBox>
<CheckBox $size="lg">큰 크기</CheckBox>`;

export const colorCode: string = `<CheckBox $bgColor="#FF6B6B" $textColor="#FFFFFF">
    빨간색 배경 + 흰색 아이콘
</CheckBox>
...
export const groupCode: string = `const [selectedItems, setSelectedItems] = useState([]);
...
export const checkboxProps: CheckboxProp[] = [
    {
        name: 'children',
        default: '-',
        type: 'ReactNode',
